---
title: "Workflows / steppers"
description: "Multi-step wizards (onboarding, troubleshooting, multi-page forms) are first-class. The server emits a workflow lifecycle; the client subscribes by id and renders any UI."
---
