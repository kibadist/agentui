...
Define a node's type, schema, component, and capability requirements in one call — props are inferred from the Zod schema and emit-time validation is automatic.
